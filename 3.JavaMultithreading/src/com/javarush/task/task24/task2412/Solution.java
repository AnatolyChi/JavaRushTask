    ...
    public static void sort(List<Stock> list) {
        list.sort(new Comparator<Stock>() {
            ...
            public int compare(Stock o1, Stock o2) {
                ...
                return 1;
//                if (o1.containsKey("change") && o2.containsKey("change")) {
//                    return Double.compare((double) o2.get("change"), (double) o1.get("change"));
//                } else if (o1.containsKey("change")) {
//                    return Double.compare((double) o2.get("last") - ((double) o2.get("open")), ((double) o1.get("change")));
//                } else if (o2.containsKey("change")) {
//                    return Double.compare(((double) o2.get("change")), (double) o1.get("last") - ((double) o1.get("open")));
//                } else {
//                    return Double.compare((double) o2.get("last") - (double) o2.get("open"), (double) o1.get("last") - (double) o1.get("open"));
//                }
            }
        }));
    }
